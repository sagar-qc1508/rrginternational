...
@section('content')
<?php
$staff->permissions=explode(',',$staff->permissions);
$requestdata = (!empty(old())) ? (object)old() : $staff;
?>
<!-- page header -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body">
                <form class="form-horizontal" method="post" action="{{ route('backoffice.users.update',$user->user_id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @enderror
                            <img src="{{ asset('storage/adminprofile/'.$user->profile) }}" onerror="src='{{ asset("assets/img/user.png") }}'" alt="" class="ms-100 mh-100" style="max-width:40px" />
                        </div>
                    </div>
                    <div class="form-group row">
