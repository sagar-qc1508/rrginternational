        ...
        <div class="row align-items-center">
            <div class="col-sm-5 col-xl-6">
                <div class="page-title">
                    <h3 class="mb-1 font-weight-bold">New Course</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-body">
                <form class="form-horizontal" method="post" action="{{ route('backoffice.courses.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label class="col-sm-3 control-label">Course Name: <i class="text-danger">*</i></label>
                        <div class="col-sm-9">
                            <input type="text" name="course_name" class="form-control form-control-sm" placeholder="Course Name" value="{{ $requestdata->course_name ?? '' }}">
                            @error('course_name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control form-control-sm" name="university_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="program_name" class="form-control form-control-sm" placeholder="Program Name" value="{{ $requestdata->program_name ?? '' }}">
                            @error('program_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group flex-nowrap">
                                        <input type="text" class="form-control form-control-sm" placeholder="Year" name="course_duration_year" value="{{ $requestdata->course_duration_year ?? '' }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="input-group flex-nowrap">
                                        <input type="text" class="form-control form-control-sm" placeholder="Month" name="course_duration_month" value="{{ $requestdata->course_duration_month ?? '' }}" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-md-6">
                                    <select class="form-control form-control-sm" name="course_fee_currency">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control form-control-sm" placeholder="Fee Amount" name="course_fee_amount" value="{{ $requestdata->course_fee_amount ?? '' }}" />
