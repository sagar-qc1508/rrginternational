    ...
    <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95" style="background-image:url({{ URL::asset('public/frontend/assets/img/inner-banner/our-company.jpg') }});">
        <div class="container">
            ...
            <div class="inner-bread-text">
                <ul>
                    <li><a href="{{ url('/') }}">Home</a> <span><i class="fa fa-angle-right"></i> Student Login </span></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    ...
                                    <div class="login-register-form">
                                        <form method="POST" id="studentLoginForm" class="studentLoginForm" action="{{ route('login') }}">
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                <input type="password" placeholder="Password" id="sPassword" name="password" required>
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="button-box">
                                                ...
                                                <!--<button name="sudentlogin" class="default-btn" type="submit"><span>Submit</span></button>-->
                                            </div>
                                        </form>
                                    </div>
                                </div>
